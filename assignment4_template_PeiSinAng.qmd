...
2.  [ABS Digital Boundary Files](https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs/edition-3-july-2021-june-2026/access-and-downloads/digital-boundary-files) [@abs_digital_2025]
    ...
    - Content: Spatial boundary shapefiles used to map service station locations to statistical areas for geographic price comparison. SA4 and SAL only.
...
2. Download the Suburb and Localities (SAL) - 2021 - Shapefile, and SA4 - 2021 - Shapefile. Click on "Download ZIP"
